...
public class PizzaExpress implements PizzaFactory {
    private static final String STORE_NAME="Pizza Express";
    @Override
    public CheesePizza createCheesePizza() {
        CheesePizza cheesePizza=new CheesePizza();
        cheesePizza.setStoreName(STORE_NAME);
        cheesePizza.setPrice(236);
        return cheesePizza;
    }
